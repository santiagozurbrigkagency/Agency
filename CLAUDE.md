...
| Agente YouTube | `agentes/agente-youtube/` | Videos largos de YouTube como máquina de conversión: idea → packaging (título y miniatura ANTES de grabar) → 3-5 problemas con solución única → guion (hook, mecanismos, los 3 CTAs) → descripción, etiquetas y métricas | `playbooks/agente-youtube.md` + `playbooks/agente-copy.md` (voz, números, anti-patrones) | Activo — pide el research de outliers (los 5 videos con más views del referente) y el packaging a modelar |

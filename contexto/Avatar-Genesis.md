...
============================================================
PASO 1 — LA ESCALERA DEL E-COMMERCE ARGENTINO
============================================================

Cada solución abre el problema siguiente. Las olas del mercado que Manu describió en el onboarding, ordenadas como escalera.

NIVEL 1 — Quiere plata por internet
  Dropshipping, COD, réplicas, bazar. Sin capital, sin producto, sin marca.
  Resolvió: vender sin stock ni capital.
  Abrió: márgenes finos, envíos largos, cero marca, cero cliente propio. Le compra al que muestra el auto.
  Le hablan: Lauti Cardozo (1.100 videos, el rey de este nivel), Andrés Caminos, Santi Duarte, Juanchy.

NIVEL 2 — Tiene tienda propia y vende, sin sistema
  Producto propio con marca —casi siempre el químico que fue trend en 2025—, Meta Ads, 0 a 10K USD. Testea productos, salta de mentoría en mentoría.
  Resolvió: tener marca y margen propio.
  Abrió: el 95% del mercado hizo exactamente lo mismo. Todos venden el mismo producto con la misma landing.
...
NIVEL 3 — Ya factura, y escala por volumen hasta que no da más   ← EL AVATAR
  ...
  Le habla: SOLO Agustín Bulacio, desde estructura fiscal y email marketing. Nadie desde el modelo de negocio.

NIVEL 4 — Opera con recurrencia
  Acumula clientes como activo. La segunda, tercera y cuarta compra no tienen costo de adquisición. Puede pagar 2,5 veces más por cliente que su competencia y seguir rentable. Facturación predecible desde el día 1 del mes. Si cae la cuenta de Meta, sigue cobrando.
  Prueba: Manu. 2.200 suscriptores activos, churn 1,28%.

A QUÉ NIVEL LE HABLAMOS: del 3 al 4.

Por qué el 3 y no el 2 (regla del SOP: apuntá al nivel más cercano al tuyo si querés cobrar más caro):
  Aprende más rápido — ya sabe correr pauta, ya tiene proveedor y marca. No hay que enseñarle e-commerce, hay que cambiarle el modelo.
  Tiene resultados más rápido — ya tiene clientes que convertir en suscriptores. El del Nivel 2 primero tiene que conseguirlos.
  Puede pagar más — la data de ventas lo confirma: la 1a1 de USD 2.100 se vende sola, la grupal de USD 500 se vendía 1 de cada 5. El comprador real de Génesis ya es Nivel 3.
  Nadie le está hablando — los siete competidores hispanos le hablan al 1 y al 2. Bulacio le habla al 3 pero desde otro lado.
...
[DATA] = soportado por reuniones, ventas o competencia.  [HIP] = hipótesis honesta, a validar con el formulario y con los últimos 10 que pagaron la 1a1.

DEMOGRÁFICOS
  Edad: 23–32. [HIP] Los alumnos que muestran los competidores tienen 19–26; el Nivel 3 es dos o tres años mayor porque ya pasó por el 1 y el 2.
  Género: mayoritariamente hombre. [DATA] Todo el contenido, creadores y alumnos de las 9 cuentas relevadas son hombres.
  Estado civil / hijos: soltero o en pareja, sin hijos. [HIP]
  ...
  País: Argentina — Buenos Aires, Córdoba, Mar del Plata, interior. [DATA]
  Capacidad de inversión: USD 2.000–5.000 en formación, demostrada. [DATA] Paga 2.100 sin esfuerzo; Fran Guess (cliente con mentoría propia) dice 5.000; el mercado cobra 6.500–10.000.

PSICOGRÁFICOS
  Valores: control sobre su negocio, independencia, hacer las cosas bien. [HIP] La resonancia del "sin humo" de Mingo y del anti-guru de Bulacio en este nivel es la señal.
  Creencias a romper:
    Que su problema es de creativos, de pauta o de producto. No lo es: es del modelo. [DATA — es el hueco de mecanismo]
    Que la suscripción es "para marcas grandes" o "para Estados Unidos". [HIP]
    Que formalizarse es imposible con estos márgenes. [DATA]
  Mentalidad: fue arriesgado (se metió en e-commerce, dejó lo seguro). Hoy está a la defensiva: protege lo que construyó. Abundancia en ambición, escasez en el día a día del margen. [HIP]
  Motivaciones: que la facturación deje de depender del mes; poder blanquear sin morir; construir algo que valga y se pueda vender. [DATA — Bulacio ya vende "activo vendible entre USD 100k y 500k" a este avatar y tiene 893 miembros: el deseo existe]
  Metas: corto — que el mes cierre con margen real, no en cero. Largo — una marca que funcione sin él encima, o que se pueda vender. [HIP]
  Miedos:
    Que Meta le baje la cuenta un martes y se quede sin nada. [DATA]
    Que el CPM siga subiendo y quede fuera de la subasta. [DATA]
    Multa, ANMAT, retención de Mercado Pago. [DATA — es el dolor que Bulacio explota]
    Que un cambio le rompa la operación que hoy funciona. [HIP — miedo específico del Nivel 3. Desde que la oferta promete "sin dejar de vender", desarmarlo es obligación contractual, no solo argumento.]
  Frustraciones: "cada venta me cuesta lo mismo que la anterior", "facturo bien y no gano", "el 1 del mes arranco en cero", "todos venden lo mismo que yo". [DATA]
  Actitud frente al dinero: piensa en ROAS, no en LTV. Invierte en pauta sin dudar; en formación, solo si ve la cuenta. [DATA — Bulacio pone "LTV por encima del ROAS" como su primer punto porque sabe que el avatar tiene la métrica al revés]
  Autoconfianza: alta en operación (ya lo hizo), baja en dirección (no sabe cuál es el siguiente paso). [HIP]

PROFESIONALES
  Experiencia: 1 a 3 años en e-commerce. Pasó por los niveles 1 y 2. [HIP]
  Tipo de contrato: emprendedor, dueño. Monotributo o informal. [DATA]
  Horas: full-time y más. La operación lo absorbe. [HIP]
  Estabilidad: ninguna. Depende de una cuenta publicitaria que no controla. [DATA]
  Capacidad de inversión: USD 2.000–5.000 en él; más en pauta que en formación. [DATA / HIP]

COMPORTAMIENTO EN REDES
  Redes: TikTok, Instagram, YouTube. Descubre en TikTok, decide en YouTube largo. [DATA — el video de backend es el más visto de Manu; el video top de Max Sturtevant es su doblaje al español, 52K vistas contra 29K del original en inglés]
  Contenido que consume: operación, backend, retención, teardowns de marcas, contenido "sin humo". [DATA]
  A quién sigue: no hay data suficiente. A validar con el formulario.
  Dispositivo: móvil para consumir, desktop para operar. [HIP]
...
Gonza tiene 27 años y vive en Córdoba. Hace dos años y medio arrancó con dropshipping, después pasó a un producto químico propio con marca, y hoy factura 60 millones de pesos por mes con Meta Ads. Suena bien hasta que abre el Excel: el CPM le subió todo el año, cada venta le deja casi lo mismo que le cuesta, y el contador le dijo que si pasa a responsable inscripto el negocio no cierra. Sabe operar —creativos, campañas, proveedor, logística— pero cada mes arranca de cero y el 1 no tiene un peso asegurado. Ya pagó dos mentorías de "producto ganador" que no le sirvieron porque él ya tiene el producto. Mira YouTube largo de backend, sigue a los que hablan sin humo, y le dio like a un video sobre suscripciones que no terminó de entender. Tiene USD 3.000 para invertir si le muestran la cuenta. Su miedo no es perder plata en un curso: es que Meta le baje la cuenta un martes y se quede sin nada. Lo que quiere no es facturar más. Es que el 1 del mes ya haya facturación.

============================================================
PASO 3 — MAPA DE DOLORES Y SOLUCIONES
============================================================
...
------------------------------------------------------------
DOLOR 2: "El CPM sube todos los meses y estoy en break-even. Si sigo así, en seis meses no estoy."
------------------------------------------------------------
  Solución común:
...
------------------------------------------------------------
DOLOR 3: "El 1 del mes arranco en cero. No sé con cuánto voy a cerrar."
------------------------------------------------------------
  Solución común:
    Bulacio → flows de email para recuperar clientes que ya compraron.
    El resto → no lo toca. Hablan de facturar más, nunca de facturar predecible.
  Nuestra solución: una base de suscriptores activos que se cobra antes de gastar un peso en pauta ese mes.
  Por qué es mejor: pasás de perseguir el mes a arrancarlo cobrado. Manu arranca cada mes con 2.200 suscriptores activos y un churn de 1,28%. La pauta suma; no sostiene.
  Nombre de la solución: Piso de Facturación

------------------------------------------------------------
DOLOR 4: "Si Meta me baja la cuenta, se termina el negocio."
------------------------------------------------------------
  Solución común:
    Bulacio → email como canal que no depende del CPM.
    Mingo → comunidad de WhatsApp como canal propio.
    El mercado → BM de respaldo, agencias de cuentas, "tené tres cuentas".
  Nuestra solución: la recurrencia no vive en Meta. Si cae la cuenta, los suscriptores siguen cobrándose. La pauta es para sumar suscriptores, no para sostener la facturación.
  Por qué es mejor: el email de Bulacio recupera clientes que ya compraron; la suscripción hace que no haya que recuperarlos. Es la diferencia entre remar y flotar.
  Nombre de la solución: Facturación a Prueba de Meta

------------------------------------------------------------
DOLOR 5: "Facturo bien pero no puedo blanquear. Si paso a responsable inscripto, no cierra."
------------------------------------------------------------
  Solución común:
...
------------------------------------------------------------
DOLOR 6: "Ya pagué dos mentorías y me enseñaron a buscar producto. Yo ya tengo producto."
------------------------------------------------------------
  Solución común:
    Juanchy → otro teardown de producto ganador.
    Lezama → una IA que valida productos.
    Duarte / Caminos → "creá tu marca desde cero" — no aplica, ya la tiene.
...
------------------------------------------------------------
  Solución común:
    Todos → diferenciarse por creativos, por branding, por hooks.
    Lezama → IA para creativos que nadie más tiene.
  Nuestra solución: la diferenciación no está en el anuncio, está en el modelo. El que te copia la landing no te copia 2.200 suscriptores.
  Por qué es mejor: un creativo se copia en 48 horas; una base de suscriptores tarda meses en construirse y no se ve desde afuera. Es la única ventaja que la competencia no puede scrapear.
  Nombre de la solución: Ventaja Invisible
...
============================================================
  ...
  Método — los siete nombres de solución son las piezas de Escalar Hacia Adentro.
  Oferta — el punto B ("arrancar el mes cobrado") y los dos "sin" salen de acá.
  Roadmap MVP y entrega DFY — el orden de las fases sigue el orden en que Gonza enfrenta los problemas.
...
============================================================
  ...
  1. Formulario interno del Discord (respuestas crudas): reescribe los [HIP] demográficos y ordena los siete dolores por frecuencia real.
